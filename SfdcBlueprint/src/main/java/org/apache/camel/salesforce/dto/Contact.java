...
public class Contact extends AbstractSObjectBase {
    ...
    // CustomExternalId__c
    private Double CustomExternalId__c;

    @JsonProperty("CustomExternalId__c")
    public Double getCustomExternalId__c() {
        return this.CustomExternalId__c;
    }

    @JsonProperty("CustomExternalId__c")
    public void setCustomExternalId__c(Double CustomExternalId__c) {
        this.CustomExternalId__c = CustomExternalId__c;
    }
